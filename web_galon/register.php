...
if (isset($_POST["register"])) {
    ...
    $sql_check_user = "SELECT * FROM admin WHERE username = '$username'";
    $result_check = mysqli_query($conn, $sql_check_user);

    if (!$result_check) {
        $_SESSION['error'] = "Kesalahan query: " . mysqli_error($conn);
        header('location: register.php');
        exit();
    }
    ...
    $sql_register = "INSERT INTO admin (username, password) VALUES ('$username', '$hashed_password')";
